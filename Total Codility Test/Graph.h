...
public:
    ...
    void depthFirstTraversal(int source, std::vector<bool>& _visited) const;
  ...
  private:
    ...
    void topologicalSortUtility(int source, std::vector<bool>& _visited, std::vector<int>& _stack);
