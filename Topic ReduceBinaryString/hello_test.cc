...
TEST(TestCleanProject, Example3) {
  std::string A = "1111010101111";
  int result = solution(A);
  auto expected = 22;
  EXPECT_EQ(result, expected);
}

TEST(TestCleanProject, Example4) {
  std::string A = "0000000000000";
  int result = solution(A);
  auto expected = 0;
  EXPECT_EQ(result, expected);
}

TEST(TestCleanProject, Example5) {
...
TEST(TestCleanProject, DISABLED_Example6) {
  std::string A = "11110100001001000000";
  int result = solution(A);
  auto expected = 1000000;
  EXPECT_EQ(result, expected);
}

TEST(TestCleanProject, Example7) {
  std::string A = "1";
  int result = solution(A);
  auto expected = 1;
  EXPECT_EQ(result, expected);
...
TEST(TestCleanProject, Example8) {
  std::string A = "0";
  int result = solution(A);
  auto expected = 0;
  EXPECT_EQ(result, expected);
